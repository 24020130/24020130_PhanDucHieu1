...
BossObject::BossObject()
{
    ...
    map_y_ = 0;
    on_ground_ = false;
    health_ = 10; // Kh?i t?o máu cho boss
    come_back_time_ = 0;
}

BossObject::~BossObject()
{
    // Gi?i phóng b? nh? bullet list
...
// Thêm hàm l?yy health c?a boss
int BossObject::GetHealth() const {
    return health_;
}

// Thêm hàm gi?m health c?a boss
